...
%%%%%%%%%   SE UTILIZA EL MÉTODO DE GAUSS SEIDEL   %%%%%%%%
while error > tolerancia
 iteraciones = iteraciones + 1;
 
 GausSeidel = ( ( diagonal + L )\ resultados ) - ( ( diagonal + L )\( U*iniciales ) );
 
 error = max( abs( (GausSeidel - iniciales) ) ); %se necesita el cambio maximo de los parametros junto con el valor absoluto
 iniciales = GausSeidel;
end